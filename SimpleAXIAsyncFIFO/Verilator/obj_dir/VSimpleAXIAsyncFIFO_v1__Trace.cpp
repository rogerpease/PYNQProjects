...
void VSimpleAXIAsyncFIFO_v1::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VSimpleAXIAsyncFIFO_v1::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
    VSimpleAXIAsyncFIFO_v1* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VSimpleAXIAsyncFIFO_v1::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
    VSimpleAXIAsyncFIFO_v1* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
