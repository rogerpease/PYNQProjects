...
void VSimpleAXIAsyncFIFO_v1::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addInitCb(&traceInit, __VlSymsp);
    traceRegister(tfp->spTrace());
}

void VSimpleAXIAsyncFIFO_v1::traceInit(void* userp, VerilatedVcd* tracep, uint32_t code) {
    // Callback from tracep->open()
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
    ...
    tracep->scopeEscape(' ');
    VSimpleAXIAsyncFIFO_v1::traceInitTop(vlSymsp, tracep);
    tracep->scopeEscape('.');
}
...
void VSimpleAXIAsyncFIFO_v1::traceInitTop(void* userp, VerilatedVcd* tracep) {
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
...
void VSimpleAXIAsyncFIFO_v1::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
    VSimpleAXIAsyncFIFO_v1* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VSimpleAXIAsyncFIFO_v1::traceRegister(VerilatedVcd* tracep) {
    // Body
    {
...
void VSimpleAXIAsyncFIFO_v1::traceFullTop0(void* userp, VerilatedVcd* tracep) {
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
    VSimpleAXIAsyncFIFO_v1* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
...
void VSimpleAXIAsyncFIFO_v1::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    VSimpleAXIAsyncFIFO_v1__Syms* __restrict vlSymsp = static_cast<VSimpleAXIAsyncFIFO_v1__Syms*>(userp);
    VSimpleAXIAsyncFIFO_v1* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
