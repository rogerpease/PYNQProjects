...
ipx::infer_core -vendor rogerpease.com -library user -taxonomy /UserIP ./Verilog/module
ipx::edit_ip_in_project -upgrade true -name edit_ip_project -directory ./project_1/project_1.tmp ./Verilog/module/component.xml
ipx::current_core ./Verilog/module/component.xml
update_compile_order -fileset sources_1
ipx::package_project -root_dir ./Verilog/module -vendor user.org -library user -taxonomy /UserIP -force
