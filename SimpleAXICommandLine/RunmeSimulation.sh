...
#/tools/Xilinx/Vivado/2020.2/bin/vivado -mode batch -source Throwaway.tcl

#
# Make sure to use "-L uva -L axi_vip_v1_1_8 -L xilinx_vip" for all the axi libraries and 
