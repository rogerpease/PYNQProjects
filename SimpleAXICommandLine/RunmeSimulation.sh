...
$VIVADO_BIN/xvlog -work xil_defaultlib \
   ...
   --include "/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "verilog/module/myip_v1_0_S00_AXI.v" \
    "verilog/module/myip_v1_0.v" \
    "verilog/tb/myip_v1_0_bfm_1_myip_0_0.v" 
...
$VIVADO_BIN/xvlog --sv -work xil_defaultlib -L uva -L axi_vip_v1_1_8 -L xilinx_vip \
  --include "./verilog/include"  \
  --include "/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
"verilog/tb/myip_v1_0_bfm_1_master_0_0_pkg.sv" \
"verilog/tb/myip_v1_0_bfm_1_master_0_0.sv" 


$VIVADO_BIN/xvlog -work xil_defaultlib -L uva -L axi_vip_v1_1_8 -L xilinx_vip \
    --include "./verilog/include"  \
    --include "/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  "verilog/tb/myip_v1_0_bfm_1.v" \
  "verilog/tb/myip_v1_0_bfm_1_wrapper.v" 

$VIVADO_BIN/xvlog --sv -work xil_defaultlib -L uva -L axi_vip_v1_1_8 -L xilinx_vip \
    --include "./verilog/include"  \
    --include "/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  "verilog/tb/myip_v1_0_tb.sv"

# compile glbl module

$VIVADO_BIN/xvlog -work xil_defaultlib -L uva -L axi_vip_v1_1_8 -L xilinx_vip  verilog/tb/glbl.v
